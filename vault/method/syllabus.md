...
**Distributions** — 2 stages: Discrete `F1.4` (Bernoulli/Binomial/Geometric/Poisson) · Continuous `F1.5` (Uniform/Exponential/Normal). *Log-normal → S6, χ² → S9.2.*
...
| S19 | 09-14 → 09-27 | F1.5 Continuous RVs + **S10.3 graphs/BFS (critical)** | Graph solvers |
