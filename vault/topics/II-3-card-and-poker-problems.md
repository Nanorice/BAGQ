...
type: topic
id: II.3
name: Card & Poker Problems
section: II
section_no: 2
source: "../../topics/section_II_classical_puzzles.md#3-card-and-poker-problems"
concepts: []
covered_by: []
coverage: none
deferred:
...
FROM "stage_maps"
WHERE contains(string(topic), "II-3-card-and-poker-problems")
```
