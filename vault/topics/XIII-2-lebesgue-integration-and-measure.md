...
type: topic
id: XIII.2
name: Lebesgue Integration & Measure
section: XIII
section_no: 13
source: "../../inventory/section_XIII_measure_theory.md#2-lebesgue-integration-and-measure"
concepts: []
covered_by: []
coverage: none
deferred:
...
# XIII.2 — Lebesgue Integration & Measure
...
FROM "stage_maps"
WHERE contains(string(topic), "XIII-2-lebesgue-integration-and-measure")
```
