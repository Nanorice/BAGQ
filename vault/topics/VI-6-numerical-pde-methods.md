...
type: topic
id: VI.6
name: Numerical PDE Methods
section: VI
section_no: 6
source: "../../topics/section_VI_derivative_pricing.md#6-numerical-pde-methods"
concepts: []
covered_by: []
coverage: none
deferred:
...
FROM "stage_maps"
WHERE contains(string(topic), "VI-6-numerical-pde-methods")
```
