...
section: V
section_no: 5
source: "../../topics/section_V_stochastic_control.md#2-markov-decision-processes"
concepts: []
covered_by: []
coverage: none
deferred:
...
# V.2 — Markov Decision Processes (MDP)
...
FROM "stage_maps"
WHERE contains(string(topic), "V-2-markov-decision-processes")
```
