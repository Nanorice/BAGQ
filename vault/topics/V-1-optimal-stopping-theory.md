...
type: topic
id: V.1
name: Optimal Stopping Theory
section: V
section_no: 5
source: "../../topics/section_V_stochastic_control.md#1-optimal-stopping-theory"
concepts: []
covered_by: []
coverage: none
deferred:
...
FROM "stage_maps"
WHERE contains(string(topic), "V-1-optimal-stopping-theory")
```
