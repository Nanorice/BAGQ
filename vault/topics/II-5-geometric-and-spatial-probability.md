...
type: topic
id: II.5
name: Geometric & Spatial Probability
section: II
section_no: 2
source: "../../inventory/section_II_classical_puzzles.md#5-geometric-and-spatial-probability"
concepts: []
covered_by: []
coverage: none
deferred:
...
# II.5 — Geometric & Spatial Probability
...
FROM "stage_maps"
WHERE contains(string(topic), "II-5-geometric-and-spatial-probability")
```
