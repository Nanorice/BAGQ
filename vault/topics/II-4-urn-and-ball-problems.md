...
type: topic
id: II.4
name: Urn & Ball Problems
section: II
section_no: 2
source: "../../topics/section_II_classical_puzzles.md#4-urn-and-ball-problems"
concepts: []
covered_by: []
coverage: none
deferred:
...
FROM "stage_maps"
WHERE contains(string(topic), "II-4-urn-and-ball-problems")
```
